...
class TabsControl {
  ...
  /**
   * Устанвливает обработчики собыйти на переключатели вкладок
   * @private
   */
  _addEventListeners() {
  ...
  /**
   * Обработчик события нажатия на переключатьль вкладки
  ...
  /**
   * Отображение открытой вкладки
   * @param {int} tabNumber - номер открытой владки
   * @private
   */
